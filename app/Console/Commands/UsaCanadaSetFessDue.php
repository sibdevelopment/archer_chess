    ...
    public function handle()
    {
        ...
        foreach ($students as $student) {
            try {
                ...
                if (!$student_batch) {
                    Log::warning('USA/Canada fees due batch update skipped: active student batch not found', [
                ...
                if (!$batch) {
                    Log::warning('USA/Canada fees due mail skipped: batch not found', [
                        'student_id' => $student->id,
                ...
                Log::error('USA/Canada fees due cron failed for student', [
                    'student_id' => $student->id,
                    'error' => $e->getMessage(),
                ]);
            }

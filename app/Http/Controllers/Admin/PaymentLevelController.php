...
class PaymentLevelController extends Controller
{
    ...
    public function store(Request $request)
    {
        $rules = [
            ...
            'malaysia_fees'   => 'required|numeric',
            'hong_kong_fees'  => 'required|numeric',
        ...
        $customMessages = [
            ...
            'malaysia_fees.required' => 'Please enter Malaysia Fees',
            'malaysia_fees.numeric'  => 'The Malaysia Fees must be a number',
            'hong_kong_fees.required' => 'Please enter Hong Kong Fees',
            'hong_kong_fees.numeric'  => 'The Hong Kong Fees must be a number',

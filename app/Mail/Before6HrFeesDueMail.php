...
class Before6HrFeesDueMail extends Mailable
{
    ...
    {
        return $this->markdown('Email.before_6hr_fees_due', [
            'student' => $this->student,
            'fee_due' => $this->fee_due,
        ])
        ->from("support@archerchessacademy.com", "Archer Chess Academy")
        ->subject("Final Reminder: Chess Classes Fee Pending for " . $this->student->first_name . ' ' . $this->student->last_name . " – Upcoming Module");
    }

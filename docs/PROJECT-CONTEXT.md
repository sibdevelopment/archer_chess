...
- Intermediate B certificate preview/PDF coordinates are tuned separately so the name sits higher and the issue date aligns correctly with the printed guide line.

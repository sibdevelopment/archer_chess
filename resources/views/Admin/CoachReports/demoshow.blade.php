            ...
            <tbody>
                @foreach($demosessions as $index => $demosession)
                    <tr>
                        ...
                        <td>{{ $demosession->time ? \Carbon\Carbon::parse($demosession->time)->format('g:i A') : '' }}</td>
                        <td>{{ $demosession->coach->user->first_name }} {{ $demosession->coach->user->last_name }}</td>
                        @php

...
@section('content')
    <form method="POST"
        action="{{ Route::is('admin.meet-our-tutors.create') ? route('admin.meet-our-tutors.store') : route('admin.meet-our-tutors.update', ['meet_our_tutor' => $meetourtutor->route_key]) }}"
        enctype="multipart/form-data" autocomplete="off" id="meetourtutor-form">
        @csrf
        {{ Route::is('admin.meet-our-tutors.create') ? '' : method_field('PUT') }}
        <div class="row">
            <div class="col-lg-12 d-flex align-items-stretch">
                <div class="card w-100">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Enter name" name="name" id="name"
                                    value="{{ isset($meetourtutor) ? $meetourtutor->name : '' }}" />
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Enter designation" name="designation" id="designation"
                                    value="{{ isset($meetourtutor) ? $meetourtutor->designation : '' }}" />
                            ...
                            <div class="col-sm-12 col-md-6 mt-2">
                                ...
                                <input type="text" class="form-control" placeholder="Enter rating" name="rating" id="rating"
                                    value="{{ isset($meetourtutor) ? $meetourtutor->rating : '' }}" />
                            ...
                            <div class="col-sm-12 col-md-6 mt-2">
                                ...
                                @if (isset($meetourtutor))
                                    <img src="{{ asset(Storage::url($meetourtutor->image)) }}" border="10" width="100"
                                        height="100" class="img-rounded img-thumbnail mt-2">
                                @endif
                            </div>
                        </div>
                    </div>
                    <div class="card-footer">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="{{ route('admin.meet-our-tutors.index') }}" type="button" class="btn btn-secondary">
                            Cancel
                            &nbsp;
    ...
    <script>
        ...
        $('#meetourtutor-form').submit(function(e) {
            e.preventDefault();
            $('div[id$="-error"]').empty();
            var form = $(this);
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == 'success') {
                        ...
                        setTimeout(function() {
                            window.location.href = "{!! route('admin.meet-our-tutors.index') !!}";
                        }, 100);
                    } else {

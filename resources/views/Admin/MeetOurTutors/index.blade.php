                            ...
                            <table class="table border table-bordered table-sm text-nowrap mb-0 align-middle"
                                ...
                                <thead class="text-dark fs-3">
                                    <tr>
                                        ...
                                        <th width="30%">
                                            <h6 class="fs-3 fw-semibold mb-0">Rating</h6>
                                        </th>
                                        <th width="60%">
    ...
    <script type="text/javascript">
        $(function() {
            var dataTable = $('#datatable').DataTable({
                ...
                scrollX: false,
                ajax: {
                    url: '{!! route('admin.meet-our-tutors.data') !!}',
                    type: 'POST',
                    data: function(d) {
        ...
        $(document).on('change', '.meetourtutors-status-switch', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                url: "{{ route('admin.meet-our-tutors.change.status') }}",
                type: 'POST',
                data: {

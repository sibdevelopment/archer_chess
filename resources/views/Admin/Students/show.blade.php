        ...
        <ul class="list-unstyled mb-0">
            ...
            <li class="d-flex align-items-center gap-3 mb-4">
                ...
                <h6 class="fs-4 fw-semibold mb-0">Password :
                    {{ isset($student->user->device_id) ? $student->user->device_id : 'Not Set' }}</h6>
            </li>

                <li class="d-flex align-items-center gap-3 mb-4">
                    <i class="ti ti-mail text-dark fs-6"></i>
                    <h6 class="fs-4 fw-semibold mb-0">Email : {{ $student->user->email ?? $student->email }}</h6>
                </li>
                <li class="d-flex align-items-center gap-3 mb-4">
            ...
            @if ($student->fees_country)
                <li class="d-flex align-items-center gap-3 mb-4">
                    <i class="ti ti-globe text-dark fs-6"></i>
                    <h6 class="fs-4 fw-semibold mb-0">Fees Country : {{ $student->fees_country }}</h6>
                </li>
            @endif
            ...
            @if ($student->portal_password)
                <li class="d-flex align-items-center gap-3 mb-4">
                    <i class="ti ti-key text-dark fs-6"></i>
                    <h6 class="fs-4 fw-semibold mb-0">Portal Password : {{ $student->portal_password }}</h6>
                </li>
            @endif
            <li class="d-flex align-items-center gap-3 mb-4">
                <i class="ti ti-fingerprint text-dark fs-6"></i>
                <h6 class="fs-4 fw-semibold mb-0 {{ $student->status == 'ACTIVE' ? 'text-success' : 'text-danger' }}">
                ...
                <ul class="list-unstyled mb-0">
                    <li class="d-flex align-items-center gap-3 mb-4">
                        ...
                        <h6 class="fs-4 fw-semibold mb-0">
                            ...
                            {{ $status->to_date
                                ? \Carbon\Carbon::parse($status->to_date)->format('M d, Y')

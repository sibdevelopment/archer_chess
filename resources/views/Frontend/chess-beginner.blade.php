...
@section('content')
    ...
    <section class="course-content pb-0" style="background: none">
        <div class="container">
            ...
            <img src="/frontend/tcul_img/Home-3.jpg.jpg" alt="Img" class="img-fluid mb-5">
        </div>
    </section>
    ...
    <section class="home-three-goals">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-xl-3 col-lg-12 col-md-12 aos-init aos-animate" data-aos="fade-down">
                    <div class="acheive-goals-main">
                        <h2>Acheive your Goals with Archer</h2>
                    </div>
                </div>


                <div class="col-xl-3 col-lg-4 col-md-4 col-12 aos-init aos-animate" data-aos="fade-down">
                    <div class="acheive-goals">
                        <div class="acheive-elips-two">
                            <img src="/frontend/assets/img/icon-three/ellipse-1.svg" alt="Img">
                        </div>
                        <div class="acheive-goals-content text-center course-count ms-0">
                            <h4><span class="counterUp">500</span>+</h4>
                            <p>Puzzle assigned</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-4 col-12 aos-init aos-animate" data-aos="fade-down">
                    <div class="acheive-goals">
                        <div class="acheive-elips-three">
                            <img src="/frontend/assets/img/icon-three/ellipse-2.svg" alt="Img">
                        </div>
                        <div class="acheive-goals-content text-center course-count ms-0">
                ...
                <div class="col-xl-3 col-lg-4 col-md-4 col-12 aos-init aos-animate" data-aos="fade-down">
                    <div class="acheive-goals">
                        <div class="acheive-elips-three">
                            <img src="/frontend/assets/img/icon-three/ellipse-3.svg" alt="Img">
                        </div>
                        <div class="acheive-goals-content text-center course-count ms-0">
                            <h4><span class="counterUp">5</span>+</h4>
                            <p>Age group</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-12 col-sm-12 ">
                        <div class="all-btn all-category d-flex align-items-center justify-content-center">
                            <a href="http://127.0.0.1:8080/book/trial/class" class="btn btn-primary">Book your free trial class now!</a>
                        </div>
                    </div>
                </div>
            </div>

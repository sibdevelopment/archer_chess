                        ...
                        <div class="blur-border course-radius align-items-center aos" data-aos="fade-up">
                            <div class="online-course d-flex align-items-center">
                                <div class="course-img">
                                    <img src="/frontend/assets/img/pencil-icon.svg" alt="Img">
                                </div>
                ...
                <div class="col-lg-3 col-md-6 d-flex">
                    <div class="course-full-width">
                        <div class="blur-border course-radius aos" data-aos="fade-up">
                            <div class="online-course d-flex align-items-center">
                                <div class="course-img">
                                    <img src="/frontend/assets/img/cources-icon.svg" alt="Img">
                                </div>
                                <div class="course-inner-content">
                                    <h4><span>200</span>+</h4>
                                    <p>Expert Tutors</p>
                ...
                <div class="col-lg-3 col-md-6 d-flex">
                    <div class="course-full-width">
                        <div class="blur-border course-radius aos" data-aos="fade-up">
                            <div class="online-course d-flex align-items-center">
                                <div class="course-img">
                                    <img src="/frontend/assets/img/certificate-icon.svg" alt="Img">
                                </div>
                                <div class="course-inner-content">
                                    <h4><span>6</span>K+</h4>
                ...
                <div class="col-lg-3 col-md-6 d-flex">
                    <div class="course-full-width">
                        <div class="blur-border course-radius aos" data-aos="fade-up">
                            <div class="online-course d-flex align-items-center">
                                <div class="course-img">
                                    <img src="/frontend/assets/img/gratuate-icon.svg" alt="Img">
                                </div>
                                <div class="course-inner-content">
        ...
        <div class="owl-carousel mentoring-course owl-theme aos" data-aos="fade-up">
                ...
                <div class="feature-bg">
                    <div class="feature-header">
                        <div class="feature-icon">
                            <img src="/frontend/assets/img/categories-icon.png" alt="Img">
                        </div>
            ...
            <div class="feature-box text-center ">
                <div class="feature-bg">
                    <div class="feature-header">
                        <div class="feature-icon">
                            <img src="/frontend/assets/img/categories-icon-01.png" alt="Img">
                        </div>
                        <div class="feature-cont">
            ...
            <div class="feature-box text-center ">
                <div class="feature-bg">
                    <div class="feature-header">
                        <div class="feature-icon">
                            <img src="/frontend/assets/img/categories-icon-02.png" alt="Img">
                        </div>
                        <div class="feature-cont">
            ...
            <div class="feature-box text-center ">
                <div class="feature-bg">
                    <div class="feature-header">
                        <div class="feature-icon">
                            <img src="/frontend/assets/img/categories-icon-03.png" alt="Img">
                        </div>
                        <div class="feature-cont">
            ...
            <div class="feature-box text-center ">
                <div class="feature-bg">
                    <div class="feature-header">
                        <div class="feature-icon">
                            <img src="/frontend/assets/img/categories-icon-04.png" alt="Img">
                        </div>
                        <div class="feature-cont">
            ...
            <div class="feature-box text-center ">
                <div class="feature-bg">
                    <div class="feature-header">
                        <div class="feature-icon">
                            <img src="/frontend/assets/img/categories-icon-05.png" alt="Img">
                        </div>
                        <div class="feature-cont">
                        ...
                        <div class="product">
                            <div class="product-img">
                                <a href="course-details.html">
                                    <img class="img-fluid" alt="Img" src="/frontend/assets/img/course/course-01.jpg">
                                </a>
                                <div class="price">
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        <a href="instructor-profile.html"><img src="/frontend/assets/img/user/user1.jpg"
                ...
                <div class="col-lg-4 col-md-6 d-flex">
                    <div class="course-box d-flex aos" data-aos="fade-up">
                        <div class="product">
                            <div class="product-img">
                                <a href="course-details.html">
                                    <img class="img-fluid" alt="Img" src="/frontend/assets/img/course/course-02.jpg">
                                </a>
                                <div class="price">
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        <a href="instructor-profile.html"><img src="/frontend/assets/img/user/user2.jpg"
                                                alt="Img" class="img-fluid"></a>
                                        <div class="course-name">
                ...
                <div class="col-lg-4 col-md-6 d-flex">
                    <div class="course-box d-flex aos" data-aos="fade-up">
                        <div class="product">
                            <div class="product-img">
                                <a href="course-details.html">
                                    <img class="img-fluid" alt="Img" src="/frontend/assets/img/course/course-03.jpg">
                                </a>
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        <a href="instructor-profile.html"><img src="/frontend/assets/img/user/user5.jpg"
                                                alt="Img" class="img-fluid"></a>
                                        <div class="course-name">
                                ...
                                <h3 class="title instructor-text"><a href="course-details.html">Sketch from A to
                ...
                <div class="col-lg-4 col-md-6 d-flex">
                    <div class="course-box d-flex aos" data-aos="fade-up">
                        <div class="product">
                            <div class="product-img">
                                <a href="course-details.html">
                                    <img class="img-fluid" alt="Img" src="/frontend/assets/img/course/course-04.jpg">
                                </a>
                                <div class="price">
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        <a href="instructor-profile.html"><img src="/frontend/assets/img/user/user4.jpg"
                                                alt="Img" class="img-fluid"></a>
                                        <div class="course-name">
                                            <h4><a href="instructor-profile.html">Nicole Brown</a></h4>
                                            <p>Instructor</p>
                ...
                <div class="col-lg-4 col-md-6 d-flex">
                    <div class="course-box d-flex aos" data-aos="fade-up">
                        <div class="product">
                            <div class="product-img">
                                <a href="course-details.html">
                                    <img class="img-fluid" alt="Img" src="/frontend/assets/img/course/course-05.jpg">
                                </a>
                                <div class="price">
                                    <h3>$300 <span>$99.00</span></h3>
                                </div>
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        <a href="instructor-profile.html"><img src="/frontend/assets/img/user/user3.jpg"
                                                alt="Img" class="img-fluid"></a>
                                        <div class="course-name">
                ...
                <div class="col-lg-4 col-md-6 d-flex">
                    <div class="course-box d-flex aos" data-aos="fade-up">
                        <div class="product">
                            <div class="product-img">
                                <a href="course-details.html">
                                    <img class="img-fluid" alt="Img" src="/frontend/assets/img/course/course-06.jpg">
                                </a>
                                <div class="price combo">
                                    <h3>FREE</h3>
                                </div>
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        <a href="instructor-profile.html"><img src="/frontend/assets/img/user/user6.jpg"
                                                alt="Img" class="img-fluid"></a>
                                        <div class="course-name">
        ...
        <div class="row">
                                ...
                                <div class="get-certified d-flex align-items-center">
                                    <div class="blur-box">
                                        <div class="certified-img ">
                                            <img src="/frontend/assets/img/icon/icon-1.svg" alt="Img" class="img-fluid">
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-6 d-flex">
                            <div class="certified-group blur-border d-flex">
                                <div class="get-certified d-flex align-items-center">
                                    <div class="blur-box">
                                        <div class="certified-img ">
                                            <img src="/frontend/assets/img/icon/icon-4.svg" alt="Img" class="img-fluid">
                                        </div>
                                    </div>
            ...
            <div class="col-lg-5 col-md-12 d-flex align-items-end">
                <div class="career-img aos" data-aos="fade-up">
                    <img src="/frontend/assets/img/join.png" alt="Img" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="owl-carousel trending-course owl-theme aos" data-aos="fade-up">
            <div class="course-box trend-box">
                <div class="product trend-product">
                    <div class="product-img">
                        <a href="course-details.html">
                            <img class="img-fluid" alt="Img" src="/frontend/assets/img/course/course-07.jpg">
                        </a>
                        <div class="price">
                    ...
                    <div class="product-content">
                        <div class="course-group d-flex">
                            <div class="course-group-img d-flex">
                                <a href="instructor-profile.html"><img src="/frontend/assets/img/user/user.jpg"
                                        alt="Img" class="img-fluid"></a>
                                <div class="course-name">
                        ...
                        <div class="course-info d-flex align-items-center">
                            <div class="rating-img d-flex align-items-center">
                                <img src="/frontend/assets/img/icon/icon-01.svg" alt="Img" class="img-fluid">
                                <p>13+ Lesson</p>
                            </div>
                            <div class="course-view d-flex align-items-center">
                                <img src="/frontend/assets/img/icon/icon-02.svg" alt="Img" class="img-fluid">
                                <p>10hr 30min</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="course-box trend-box">
                <div class="product trend-product">
                    <div class="product-img">
                        <a href="course-details.html">
                            <img class="img-fluid" alt="Img" src="/frontend/assets/img/course/course-08.jpg">
                        </a>
                        <div class="price">
                            <h3>$300 <span>$99.00</span></h3>
                        </div>
                    ...
                    <div class="product-content">
                        ...
                        <h3 class="title"><a href="course-details.html">Responsive Web Design Essentials HTML5
            ...
            <div class="course-box trend-box">
                <div class="product trend-product">
                    ...
                    <div class="product-content">
                        ...
                        <h3 class="title"><a href="course-details.html">The Complete App Design Course - UX, UI
            ...
            <div class="course-box trend-box">
                <div class="product trend-product">
                    <div class="product-img">
                        <a href="course-details.html">
                            <img class="img-fluid" alt="Img" src="/frontend/assets/img/course/course-09.jpg">
                        </a>
                        <div class="price">
                            <h3>$100 <span>$99.00</span></h3>
                        </div>
        ...
        <div class="feature-instructors">
            ...
            <div class="owl-carousel instructors-course owl-theme aos" data-aos="fade-up">
                <div class="instructors-widget">
                    <div class="instructors-img ">
                        <a href="instructor-list.html">
                            <img class="img-fluid" alt="Img" src="/frontend/assets/img/user/user7.jpg">
                        </a>
                    </div>
                ...
                <div class="instructors-widget">
                    <div class="instructors-img">
                        <a href="instructor-list.html">
                            <img class="img-fluid" alt="Img" src="/frontend/assets/img/user/user8.jpg">
                        </a>
                    </div>
                    <div class="instructors-content text-center">
                ...
                <div class="instructors-widget">
                    <div class="instructors-img">
                        <a href="instructor-list.html">
                            <img class="img-fluid" alt="Img" src="/frontend/assets/img/user/user9.jpg">
                        </a>
                    </div>
                    <div class="instructors-content text-center">
                ...
                <div class="instructors-widget">
                    <div class="instructors-img">
                        <a href="instructor-list.html">
                            <img class="img-fluid" alt="Img" src="/frontend/assets/img/user/user10.jpg">
                        </a>
                    </div>
                    <div class="instructors-content text-center">
    ...
    <div class="container">
        ...
        <div class="lead-group aos" data-aos="fade-up">
            <div class="lead-group-slider owl-carousel owl-theme">
                <div class="item">
                    <div class="lead-img">
                        <img class="img-fluid" alt="Img" src="/frontend/assets/img/lead-01.png">
                    </div>
                </div>
                <div class="item">
                    <div class="lead-img">
                        <img class="img-fluid" alt="Img" src="/frontend/assets/img/lead-02.png">
                    </div>
                </div>
                <div class="item">
                    <div class="lead-img">
                        <img class="img-fluid" alt="Img" src="/frontend/assets/img/lead-03.png">
                    </div>
                </div>
                <div class="item">
                    <div class="lead-img">
                        <img class="img-fluid" alt="Img" src="/frontend/assets/img/lead-04.png">
                    </div>
                </div>
                <div class="item">
                    <div class="lead-img">
                        <img class="img-fluid" alt="Img" src="/frontend/assets/img/lead-05.png">
                    </div>
                </div>
                <div class="item">
                    <div class="lead-img">
                        <img class="img-fluid" alt="Img" src="/frontend/assets/img/lead-06.png">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="review">
        <div class="container">
            <div class="testi-quotes">
                <img src="/frontend/assets/img/qute.png" alt="Img">
            </div>
                        ...
                        <div class="testimonial-two-head text-center align-items-center d-flex">
                            <div class="testimonial-four-saying ">
                                <div class="testi-right">
                                    <img src="/frontend/assets/img/qute-01.png" alt="Img">
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-12">
                            <div class="mentor-img">
                                <img class="img-fluid" alt="Img" src="/frontend/assets/img/icon/become-02.svg">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="student-mentor yellow-mentor">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="mentor-img">
                                <img class="img-fluid" alt="Img" src="/frontend/assets/img/icon/become-01.svg">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="owl-carousel blogs-slide owl-theme aos" data-aos="fade-up">
            <div class="instructors-widget blog-widget">
                <div class="instructors-img">
                    <a href="blog-list.html">
                        <img class="img-fluid" alt="Img" src="/frontend/assets/img/blog/blog-01.jpg">
                    </a>
                </div>
                <div class="instructors-content text-center">
            ...
            <div class="instructors-widget blog-widget">
                <div class="instructors-img">
                    <a href="blog-list.html">
                        <img class="img-fluid" alt="Img" src="/frontend/assets/img/blog/blog-02.jpg">
                    </a>
                </div>
                <div class="instructors-content text-center">
            ...
            <div class="instructors-widget blog-widget">
                <div class="instructors-img">
                    <a href="blog-list.html">
                        <img class="img-fluid" alt="Img" src="/frontend/assets/img/blog/blog-03.jpg">
                    </a>
                </div>
                <div class="instructors-content text-center">
            ...
            <div class="instructors-widget blog-widget">
                <div class="instructors-img">
                    <a href="blog-list.html">
                        <img class="img-fluid" alt="Img" src="/frontend/assets/img/blog/blog-04.jpg">
                    </a>
                </div>
                <div class="instructors-content text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-1 col-3">
                            <div class="total-course d-flex align-items-center">
                                <div class="blur-border">
                                    <div class="enroll-img ">
                                        <img src="/frontend/assets/img/icon/icon-10.svg" alt="Img" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-1 col-3">
                            <div class="total-course d-flex align-items-center">
                                <div class="blur-border">
                                    <div class="enroll-img ">
                                        <img src="/frontend/assets/img/icon/icon-16.svg" alt="Img" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-1 col-3">
                            <div class="total-course d-flex align-items-center">
                                <div class="blur-border">
                                    <div class="enroll-img ">
                                        <img src="/frontend/assets/img/icon/icon-12.svg" alt="Img" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-1 col-3">
                            <div class="total-course d-flex align-items-center">
                                <div class="blur-border">
                                    <div class="enroll-img ">
                                        <img src="/frontend/assets/img/icon/icon-13.svg" alt="Img" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-1 col-3">
                            <div class="total-course d-flex align-items-center">
                                <div class="blur-border">
                                    <div class="enroll-img ">
                                        <img src="/frontend/assets/img/icon/icon-14.svg" alt="Img" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-1 col-3">
                            <div class="total-course d-flex align-items-center">
                                <div class="blur-border">
                                    <div class="enroll-img ">
                                        <img src="/frontend/assets/img/icon/icon-15.svg" alt="Img" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-1 col-3">
                            <div class="total-course d-flex align-items-center">
                                <div class="blur-border">
                                    <div class="enroll-img ">
                                        <img src="/frontend/assets/img/icon/icon-17.svg" alt="Img" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-1 col-3">
                            <div class="total-course d-flex align-items-center">
                                <div class="blur-border">
                                    <div class="enroll-img ">
                                        <img src="/frontend/assets/img/icon/icon-18.svg" alt="Img" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
